...
RUN yum update -y && yum install -y git && yum install -y git https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm && yum install -y ansible && yum clean all -y
